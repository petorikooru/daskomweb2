...
class RolePermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($assistantRoles as $roleName) {
            Role::firstOrCreate([
                'name' => $roleName,
                'guard_name' => 'asisten',
            ]);
        ...
        Permission::firstOrCreate(['name' => 'lihat-profile', 'guard_name' => 'praktikan', 'created_at' => now(), 'updated_at' => now()]);
        Permission::firstOrCreate(['name' => 'lihat-nilai', 'guard_name' => 'praktikan', 'created_at' => now(), 'updated_at' => now()]);
        Permission::firstOrCreate(['name' => 'lihat-modul', 'guard_name' => 'praktikan', 'created_at' => now(), 'updated_at' => now()]);
        Permission::firstOrCreate(['name' => 'lihat-asisten', 'guard_name' => 'praktikan', 'created_at' => now(), 'updated_at' => now()]);
        Permission::firstOrCreate(['name' => 'praktikum-lms', 'guard_name' => 'praktikan', 'created_at' => now(), 'updated_at' => now()]);
        Permission::firstOrCreate(['name' => 'lihat-leaderboard', 'guard_name' => 'praktikan', 'created_at' => now(), 'updated_at' => now()]);
        Permission::firstOrCreate(['name' => 'isi-polling', 'guard_name' => 'praktikan', 'created_at' => now(), 'updated_at' => now()]);
        Permission::firstOrCreate(['name' => 'ganti-password', 'guard_name' => 'praktikan', 'created_at' => now(), 'updated_at' => now()]);
        Permission::firstOrCreate(['name' => 'logout-praktikan', 'guard_name' => 'praktikan', 'created_at' => now(), 'updated_at' => now()]);
